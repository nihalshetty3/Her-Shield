...
const SosButton = ({ isHovered, isActive }) => {
  return (
    <div className="relative w-full h-24 flex items-center justify-center overflow-hidden bg-white/2 rounded-2xl border border-white/5">
      ...
      <div className={`absolute w-14 h-14 rounded-full bg-gradient-to-tr from-neon-orchid to-purple-600 blur-xl opacity-30 transition-all duration-700 ${
        isHovered ? 'scale-130 opacity-60' : 'scale-90'
      }`} />
